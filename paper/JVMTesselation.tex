...
%TODO Why do GC and AOT need to communicate?

%TODO Figure out how to cite http://www.oracle.com/technetwork/java/javase/memorymanagement-whitepaper-150215.pdf


%TODO Reference HDFS, Hadoop, Spark?
...
%TODO Do I need to reference Juan's paper again when I mention two-level scheduling.
...
%TODO cite sources of OpenJDK, Oracle, Sun, comparisons, and source of similarity assumption

The HotSpot JVM is designed as a premiere, high-performance environment for Java applications with a focus on performance optimization. On top of implementing the features required by the aforementioned Java Virtual Machine specification, HotSpot provides a number of options and operating modes for tuning for different use cases. This focus is embodied in HotSpot's implementation of the garbage collector and adaptive optimizer.

\subsubsection{HotSpot Garbage Collector}

Describe the modes of garbage collection we are doing. We should talk about exploring the other garbage collector options in the future work section.	
